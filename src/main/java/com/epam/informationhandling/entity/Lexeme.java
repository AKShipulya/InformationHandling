...
public class Lexeme implements Component {
    ...
    public boolean equals(Object object) {
        ...
        Lexeme lexemeForEquals = (Lexeme) object;
        if (this.lexeme != null ? !this.lexeme.equals(lexemeForEquals.lexeme) : lexemeForEquals.lexeme != null) {
            return false;
        }
        return lexemeType == lexemeForEquals.lexemeType;
    }
